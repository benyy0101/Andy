...
export default function ProfileBox() {
  ...
  const emptyImage =
    "https://andyimagebucket.s3.ap-northeast-2.amazonaws.com/profiles/defaultProfile.png";
  ...
  const childBirth = isLoading
    ? "로딩중"
    : formatDateArray(data?.child_birthday || []);
  ...
  const getGenderLabel = (gender1: string) =>
    gender1 === "M" ? "남자" : "여자";
        ...
        <ProfileImage>
          ...
          {isEditing ? (
            ...
            >
              ...
              />
              <Image
                src={imagePreview || data?.child_picture || emptyImage}
                alt="프로필사진"
                priority
                width="150"
                height="150"
            ...
            <ProfileImage1>
              <Image
                src={data?.child_picture || emptyImage}
                alt="프로필사진"
                width="200"
                height="200"
                className="rounded-[100%] shadow-lg"
        ...
        <Form>
          <Name>
            ...
            {isEditing ? (
              ...
              <CurrentInfo>
                <InfoWrapper>{data?.child_name || "로딩중"}</InfoWrapper>
              </CurrentInfo>
            )}
          </Name>
          ...
          <Nickname>
            ...
            {isEditing ? (
              ...
              <CurrentInfo>
                <InfoWrapper>{data?.child_nickname || "로딩중"}</InfoWrapper>
              </CurrentInfo>
            )}
          </Nickname>
          ...
          <Birth>
            ...
            {isEditing ? (
              ...
              <CurrentInfo>
                <InfoWrapper>{childBirth}</InfoWrapper>
              </CurrentInfo>
            )}
          </Birth>
          ...
          <Gender>
            ...
            {isEditing ? (
              ...
              <CurrentInfo>
                <InfoWrapper>{getGenderLabel(data?.child_gender)}</InfoWrapper>
              </CurrentInfo>
            )}
          </Gender>
